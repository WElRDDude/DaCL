 ...
 *
 * @note Preview functionality is optional and typically used during
 * development. Requires X11 forwarding or local display for GUI output.
 */
...
private:
  const std::string
      bufferDir_; ///< Directory containing video segments to preview
