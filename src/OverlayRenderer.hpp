 ...
 * 
 * Generated overlays are used by FFmpeg to annotate video files during event processing.
 * 
...
public:
     ...
     * 
     * @note Generated overlay files are temporary and should be cleaned up after use
     */
    std::string renderOverlay(int speed, 
