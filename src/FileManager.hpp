 ...
 * 
 * @note This class performs file I/O operations and may throw filesystem exceptions
 */
...
public:
     ...
     */
    explicit FileManager(const std::string &bufferDir, const std::string &eventDir);
     ...
     * 
     * @note This method is typically called by StorageManager to maintain buffer size
     */
    void cleanOldSegments(int maxMinutes);

private:
    const std::string bufferDir_;  ///< Source directory for buffered video segments
